...
# encontrar la fuerza de gravedad
...
def ceviche_menu(cant,precio_ceviche):
    ...
    if(resultado>30):
        ...
        return msg+"==>"+str(resultado)

        return resultado

#14.-funcion ==> bonificacion para trabajadores
def bonificacion(cliente,horas_extra):
    if(cliente=="contratado"):
        boni=horas_extra*30
        return boni
    else:
        return "no tiene bonificacion"
